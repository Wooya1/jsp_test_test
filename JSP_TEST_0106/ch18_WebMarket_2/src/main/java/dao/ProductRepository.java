...
// 상품 목록 부분은 해당 디비 서버에 연결이 되어서 , 불러오게 연동이 되었다면. 
	...
	public ProductRepository() {
		...
		Product zflip = new Product("p1237", "test", 1200000);
		zflip.setDescription("test");
		zflip.setCategory("test");
		zflip.setManufacturer("test");
		zflip.setUnitsInStock(11);
		zflip.setCondition("New");
		zflip.setFilename("p1237.jpg");
